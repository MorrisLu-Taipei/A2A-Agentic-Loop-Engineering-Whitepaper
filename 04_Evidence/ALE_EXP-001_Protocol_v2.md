...
**狀態 / Status**：**Protocol Frozen; Runner Incomplete**(協定已凍結;但 `experiments/EXP-001/runner` 仍含 `NotImplementedError`,缺陷注入/D gate/成本記錄未實作 → **尚不可執行**,**不可隨 DOI 公開原始碼**。原 v1、v1_gemini 保留)
**對應白皮書**：`ALE_WhitePaper_v3.0.md` §1.4、§7.1–7.3、§9.7、§10、§12.2
